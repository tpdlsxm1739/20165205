...
public class Shape extends ImageIcon {
	...
	public Shape(String imgURL, int x, int y, int margin, int steps, int xBoundary, int yBoundary) {
		// imgURL : 그림 파일의 경로명
		// x, y : 이미지의 시작 위치 좌표
	...
	public Shape(String imgURL, int margin, int xBoundary, int yBoundary) {
