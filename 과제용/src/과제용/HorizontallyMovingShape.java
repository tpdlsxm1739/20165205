...
public class HorizontallyMovingShape extends Shape{
	public HorizontallyMovingShape(String imgURL, int x, int y, int margin, int steps, int xBoundary, int yBoundary) {
		// imgPath : 그림 파일의 경로명
		// x, y : 이미지의 위치 좌표
	...
	public HorizontallyMovingShape(String imgURL,int margin, int steps, int xBoundary, int yBoundary) {
